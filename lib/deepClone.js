...
var ArrayClone = function ArrayClone(arg) {
  ...
  clone_arr.push.apply(clone_arr, (0, _toConsumableArray2["default"])(result));
  return clone_arr;
};
...
var isSimpleData = function isSimpleData(arg) {
  return Type.isBool(arg) || Type.isNil(arg) || Type.isString(arg) || Type.isNumber(arg) || Type.isRegexp(arg) || Type.isDate(arg) || Type.isError(arg) || Type.isSymbol(arg);
};
...
var target = {
  ...
  num: new Number(2),
  str: new String(2),
  symbol: Object((0, _symbol["default"])('2')),
  date: new Date(),
